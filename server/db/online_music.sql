...
CREATE TABLE `blog_article` (
  ...
  `author_id` int DEFAULT '1' COMMENT '发布者 不能为空',
  `category_id` int DEFAULT NULL COMMENT '分类id 不能为空',
  `article_content` text COMMENT '文章内容',
  `article_cover` varchar(1234) DEFAULT 'https://example.com/default.png' COMMENT '文章缩略图',
...
CREATE TABLE `blog_config` (
  `id` int NOT NULL AUTO_INCREMENT,
  `blog_name` varchar(55) DEFAULT '音乐创作' COMMENT '名称',
  `blog_avatar` varchar(255) DEFAULT 'https://example.com/default.png' COMMENT '博客头像',
  `avatar_bg` varchar(255) DEFAULT NULL COMMENT '头像背景图',
  `personal_say` varchar(255) DEFAULT NULL COMMENT '个人签名',
  `blog_notice` varchar(255) DEFAULT NULL COMMENT '公告',
  ...
  `view_time` bigint DEFAULT '0' COMMENT '被访问的次数',
  `createdAt` datetime DEFAULT NULL,
  `updatedAt` datetime DEFAULT NULL,
