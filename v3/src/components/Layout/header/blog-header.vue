    ...
    <div class="pc_menu flex_r_between">
      ...
      <div class="flex_r_around">
        ...
        >
          ...
          <el-menu-item index="/category"><i class="iconfont icon-sort"></i>乐谱分享</el-menu-item>
          <el-menu-item index="/photoAlbum"><i class="iconfont icon-paper"></i>AI乐谱</el-menu-item>
          <el-menu-item index="/archives"><i class="iconfont icon-icon"></i> 时间轴</el-menu-item>
          <el-sub-menu index="/resources">
            <template #title><i class="iconfont icon-menu"></i> 知识分享</template>
            <el-menu-item index="/resources/front"
              ><i class="iconfont icon-folder"></i> 乐理知识分享</el-menu-item
            >
            <el-menu-item index="/resources/back"
              ><i class="iconfont icon-houduankaifa"></i> 音乐与代码交互知识分享</el-menu-item
            >
